...
for(model_tmp in list_models_param){
	...
	posterior = get_posterior(nameA=nameA, nameB=nameB, nSubdir=nSubdir, sub_dir_sim=sub_dir_sim, model=model_tmp, sub_dir_model=model_tmp, nPosterior=nPosterior, figure=F, timeStamp=timeStamp, path2observation=path2observation)
