...
if len(sys.argv) != 10:
	...
	print("\n\tex: submit_simulations_2pop_popGrowth.py 1000 2 SI_1N flo mal sim_SI_1N SI_1N config.yaml Ng4PymB1dy\n\tto simulate 1000 multilocus simulations at the second iteration, in the folder sim_SI_1N") 
	sys.exit(0)
...
tmp += "priorgen_2pop_popGrowth.py {0} {1} {2} | msnsam tbs {3} {4} | mscalc_2pop.py".format(model, nmultilocus, config_yaml, nmultilocus*nlocus, mscommand)
