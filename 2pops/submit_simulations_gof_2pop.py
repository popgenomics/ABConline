...
if len(sys.argv) != 12:
	print("\n\tsubmit_simulations_gof_2pop.py [outgroup] [nmultilocus] [iteration] [model: SI_x AM_x IM_x SC_x PSC_x PAM_x] [nameA] [nameB] [sub_dir_sim] [sub_dir_model] [posterior_file] [beta or bimodal]")
...
tmp += "priorgen_gof_2pop.py {0} {1} {2} {6} | msnsam tbs {3} {4} | mscalc_2pop_SFS.py {5}".format(model, nmultilocus, posterior_file, nmultilocus*nlocus, mscommand, outgroup, modeBarrier)
