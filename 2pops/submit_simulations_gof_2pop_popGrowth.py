...
if len(sys.argv) != 11:
	print("\n\t submit_simulations_gof_2pop_popGrowth.py [nmultilocus] [iteration] [model: SI_x AM_x IM_x SC_x PSC_x PAM_x] [nameA] [nameB] [sub_dir_sim] [sub_dir_model] [posterior_file]")
	print("\n\tex: submit_simulations_gof_2pop_popGrowth.py 1000 2 SI_1N flo mal sim_SI_1N SI_1N posterior_IM_1M_2N.txt\n\tto simulate 1000 multilocus simulations at the second iteration, in the folder sim_SI_1N") 
	sys.exit(0)
...
tmp += "priorgen_gof_2pop_popGrowth.py {0} {1} {2} | msnsam tbs {3} {4} | mscalc_2pop_SFS.py {5}".format(model, nmultilocus, posterior_file, nmultilocus*nlocus, mscommand, outgroup)
